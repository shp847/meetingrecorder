...
- stages in-place update bundles under the installer temp area when it shares a drive with the managed install, validates that staged copy, and only then promotes files into `%USERPROFILE%\Documents\MeetingRecorder`
