...
- Specific quiet Teams desktop meetings can auto-start after the same named meeting window remains visible for 20 seconds only when audio is attributed to Teams or the audio probe is unavailable; generic, navigation, playback, and silent stale meeting windows remain excluded
