...
- Full Meetings cleanup refreshes auto-apply up to five current `Safe Fix` items per app run, while leaving review-first recommendations visible and manual bulk retry available
