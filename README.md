...
- Windows audio-session probing now classifies system sounds, inactive sessions, and the app's own audio before resolving process names, reducing endpoint-protection prompts from service-hosted Windows audio sessions such as `svchost.exe`
